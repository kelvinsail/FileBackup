...
public class DirIterator {
    ...
    private static final String TAG = "DirIterator";
     ...
     */
    public DirIterator(IFile file, OnAsyncIteratorListener listener) {
        this.mFile = file;
     ...
     * 遍历文件处理监听器，异步
     *
     * @param <T> 传入{@link DirIterator}的Tag对象，可使用对象、接口作为tag
     */
