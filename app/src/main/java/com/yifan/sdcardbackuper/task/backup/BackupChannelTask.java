 ...
 */
public class BackupChannelTask extends BaseAsyncTask<Object, CopyProgress, CopyProgress> {
    ...
    private boolean copyFile(String path, String targetPath, DocumentFile documentFile, boolean isStatistics) {
        ...
        try {
            ...
            if (isSAFUseing) {
                ...
                targetFile = targetDir.createFile(com.yifan.sdcardbackuper.utils.FileUtils.getMimeType(new File(path)), inputFile.getName());
